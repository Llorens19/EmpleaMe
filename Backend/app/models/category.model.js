...
category_schema.methods.addJob = function (job_id) { //se usa para añadir al array jobs la id de un trabajo si esta no esta en el array
...
module.exports = mongoose.model('Category', category_schema); //exportamos el modelo Category